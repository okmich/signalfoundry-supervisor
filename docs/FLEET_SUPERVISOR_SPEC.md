...
> 2026-06-02 (targeted Ctrl+C via AttachConsole, §9); bulk operations specified 2026-06-03 (§11.1). **Implementation started** in this repo
> (`signalfoundry-supervisor`) — see `../README.md`. Companion contracts (`LOGGING_CONTRACT.md`,
